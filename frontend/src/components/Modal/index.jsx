          ...
          <MDBModalContent>
            ...
            <MDBModalBody>
              <div className='row'>
                ...
                <div className='col-9'>
                  <p><strong>{product.title}</strong> foi adicionado ao carrinho!</p>
...
export const CommentModal = ({ addComment }) => {
  ...
  return (
    <>
      <MDBBtn onClick={toggleOpen} className='btn-dark'>Avaliar</MDBBtn>
                ...
                <MDBCardBody className="p-4">
                  <div className="d-flex flex-start w-100">
                    ...
                    <div className="w-100">
                      ...
                      <MDBTypography tag="h5">Adicionar comentário</MDBTypography>
                        <div>
                          {[...Array(5)].map((_, index) => (
                            <MDBIcon
                              key={index}
